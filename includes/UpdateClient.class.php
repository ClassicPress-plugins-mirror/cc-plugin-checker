...
namespace SimplyComputing\CCPluginChecker;

// EDIT: URL where Update Manager is installed; with trailing slash!

const UPDATE_SERVER = 'https://simplycomputing.com.au/';
...
const SECURE_SOURCE = 'https://github.com/simplycomputing/cc-plugin-checker/';
